...
It then uses "hashery's":http://rubyworks.github.com/hashery "OpenCascade":https://github.com/rubyworks/hashery class to turn the API's hash response into callable methods.
